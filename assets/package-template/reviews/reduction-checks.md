...
- What detail is optional and can be removed:
- Whether silhouette memory survives:
...
## Adaptive / Themed Checks

- Android foreground survives:
- Android background role is clear:
